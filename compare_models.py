...
compare_models.py
=================
Compare KNN, SVM, and Softmax classifiers using nested k-fold cross-validation
from k_fold_validation.py for simultaneous hyperparameter tuning and model selection.
"""
...
# ---------------------------------------------------------------------------
# Model definitions  (name, class, hyperparameter_grid)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Run nested CV  (outer=5, inner=3 keeps it fast; raise to 5/5 for rigor)
# ---------------------------------------------------------------------------
...
for name, res in results.items():
    ...
    # most common hyperparameter set across outer folds
